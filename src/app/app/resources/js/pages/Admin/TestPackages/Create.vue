...
import type { Program, Test } from '@/types/models';
import { X } from 'lucide-vue-next';

const props = defineProps<{ programs: Program[]; tests: Test[] }>();

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Admin', href: '/admin' },
    { title: 'Test Packages', href: '/admin/test-packages' },
    { title: 'Create', href: '/admin/test-packages/create' },
];
...
const form = useForm({
    ...
    is_active: true,
    sort_order: 0,
    items: [] as { test_id: string; sort_order: number }[],
});
...
function submit() {
    form.post('/admin/test-packages');
}
</script>

<template>
    <Head title="Create Test Package" />
    <AdminLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-2xl">
            <Card>
                <CardHeader><CardTitle>Create Test Package</CardTitle></CardHeader>
                <CardContent>
